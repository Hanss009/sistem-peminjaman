                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error ('nama_aset') is-invalid @enderror"
                                id="nama_aset" name="nama_aset" value="{{old('nama_aset')}}"
                            ...
                            <select class="form-control @error('tipe_aset') is-invalid @enderror" name="tipe_aset" id="tipe_aset">
                                ...
                                <option value="properti" {{ old('tipe_aset') == 'properti' ? 'selected' : '' }}>Properti</option>
                                <option value="elektronik_it" {{ old('tipe_aset') == 'elektronik_it' ? 'selected' : '' }}>Elektronik IT</option>
                                <option value="inventaris" {{ old('tipe_aset') == 'inventaris' ? 'selected' : '' }}>Inventaris</option>
                            </select>
                            @error('tipe_aset')
                            ...
                            <input type="text" class="form-control @error ('no_aset') is-invalid @enderror"
                                id="no_aset" name="no_aset" value="{{old('no_aset')}}"
                            ...
                            <select class="form-control @error('status_aset') is-invalid @enderror" name="status_aset" id="status_aset">
                                ...
                                <option value="tidak_aktif" {{ old('status_aset') == 'tidak_aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                <option value="services" {{ old('status_aset') == 'services' ? 'selected' : '' }}>Services</option>
                            </select>
                            @error('status_aset')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
