                ...
                <form action="{{  url('kendaraan/' . $kendaraan->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <select class="form-control @error('jenis_kendaraan') is-invalid @enderror" name="jenis_kendaraan" id="jenis_kendaraan">
                            ...
                            <option value="sepeda_motor" {{ old('jenis_kendaraan', $kendaraan->jenis_kendaraan) == 'sepeda_motor' ? 'selected' : '' }}>Sepeda Motor</option>
                        </select>
                        ...
                        <select class="form-control @error('merk_kendaraan') is-invalid @enderror" name="merk_kendaraan" id="merk_kendaraan">
                            ...
                            <option value="mitsubishi" {{ old('merk_kendaraan', $kendaraan->merk_kendaraan) == 'mitsubishi' ? 'selected' : '' }}>Mitsubishi</option>
                            <option value="honda" {{ old('merk_kendaraan', $kendaraan->merk_kendaraan) == 'honda' ? 'selected' : '' }}>Honda</option>
                            <option value="dll" {{ old('merk_kendaraan', $kendaraan->merk_kendaraan) == 'dll' ? 'selected' : '' }}>Dan lainnya</option>
                        </select>
                        ...
                        <input type="text" class="form-control @error ('warna_kendaraan') is-invalid @enderror"
                            id="warna_kendaraan" name="warna_kendaraan" value="{{old('warna_kendaraan', $kendaraan->warna_kendaraan)}}"
                        ...
                        <div class="mt-1">
                            ...
                            <img src="{{asset('storage/foto_kendaraan/' . $kendaraan->foto_kendaraan)}}" alt="" width="88px">
                        </div>
                        ...
                        <input type="date" class="form-control-file @error('tgl_berakhir_stnk') is-invalid @enderror" id="tgl_berakhir_stnk"
                            name="tgl_berakhir_stnk" value="{{old('tgl_berakhir_stnk', $kendaraan->tgl_berakhir_stnk)}}" accept="image/*">
                        ...
                        <select class="form-control @error('status_kepemilikan') is-invalid @enderror" name="status_kepemilikan" id="status_kepemilikan">
                            ...
                            <option value="pribadi" {{ old('status_kepemilikan', $kendaraan->status_kepemilikan) == 'pribadi' ? 'selected' : '' }}>Pribadi</option>
                            <option value="yayasan" {{ old('status_kepemilikan', $kendaraan->status_kepemilikan) == 'yayasan' ? 'selected' : '' }}>Yayasan</option>
                        ...
                        <select class="form-control @error('status_kendaraan') is-invalid @enderror" name="status_kendaraan" id="status_kendaraan">
                            ...
                            <option value="aktif" {{ old('status_kendaraan', $kendaraan->status_kendaraan) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                            <option value="tidak_aktif" {{ old('status_kendaraan', $kendaraan->status_kendaraan) == 'tidak_aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                            <option value="services" {{ old('status_kendaraan', $kendaraan->status_kendaraan) == 'services' ? 'selected' : '' }}>Services</option>
                            <option value="rusak" {{ old('status_kendaraan', $kendaraan->status_kendaraan) == 'rusak' ? 'selected' : '' }}>Rusak</option>
                        </select>
