                    ...
                    <form method="GET" action="{{ route('laporan.peminjaman') }}" class="mb-4">
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-4">
                                ...
                                <a href="{{ route('laporan.peminjaman') }}" class="btn btn-secondary mt-2">Reset</a>
                            </div>
                        </div>
                    </form>
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ date('d-m-Y H:i', strtotime($item->waktu_awal_pinjam)) }}</td>
                                <td>{{ date('d-m-Y H:i', strtotime($item->waktu_akhir_pinjam)) }}</td>
                                <td>{{ $item->tujuan }}</td>
