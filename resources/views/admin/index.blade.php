...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <a href="{{ url('admin/create') }}" class="btn btn-primary" data-toggle="modal"
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->foto)
                                                <img src="{{ asset('storage/foto/' . $item->foto) }}" alt="Foto" width="60" style="cursor:pointer;"
                                                    data-toggle="modal" data-target="#fotoModal" data-img="{{ asset('storage/foto/' . $item->foto) }}">
                                                @else
                                            ...
                                            <td>
                                                <center>
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#changePasswordModal{{ $item->id }}">
                                                        Ganti Password
                                                    </button>
                                                    ...
                                                    <form id="delete-form-{{ $item->id }}" action="{{ url('admin/' . $item->id) }}" method="POST" style="display:none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </center>
    ...
    @include('admin.modal-edit', ['item' =>$item])

    <!-- modal change password -->
    @include('admin.modal-change-password', ['item' => $item])
