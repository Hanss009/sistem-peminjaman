                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.form-pengembalian', $peminjaman->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control" value="{{ $peminjaman->waktu_awal_pinjam }}" readonly>
                                        </div>

                                        <div class="form-group">
                                            <label>Tanggal Akhir Pinjam</label>
                                            <input type="datetime-local" class="form-control" value="{{ $peminjaman->waktu_akhir_pinjam }}" readonly>
                                        </div>

                                        <div class="form-group">
                                            <label>KM Pergi</label>
                                            <input type="text" class="form-control" value="{{ $peminjaman->km_pergi }}" readonly>
                                        </div>

                                        <div class="form-group">
                                            <label for="km_kembali">KM Kembali</label>
                                            <input type="number" name="km_kembali" class="form-control @error('km_kembali') is-invalid @enderror" value="{{ old('km_kembali') }}">
                                            @error('km_kembali') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

                                        <div class="form-group">
                                            <label for="waktu_kembali">Waktu Kembali</label>
                                            <input type="datetime-local" name="waktu_kembali" class="form-control @error('waktu_kembali') is-invalid @enderror" value="{{ old('waktu_kembali') }}">
                                            @error('waktu_kembali') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>
